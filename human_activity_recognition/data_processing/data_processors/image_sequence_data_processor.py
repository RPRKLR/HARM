...
class ImageSequenceDataProcessor:

    """The ImageSequenceDataProcessor class is responsible for executing data
    processing step after the EDA which extracts frame sequences from videos and
    ...
    def __init__(self, logger: Logger, data_classes: List[str]) -> None:
        ...
        create_missing_directory(
            path=self.__pickled_folder_path, logger=self.__logger
        )

    def extract_fames(self, video_path: str) -> List[MatLike]:
