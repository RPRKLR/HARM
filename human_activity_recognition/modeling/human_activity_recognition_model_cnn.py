...
class HumanActivityRecognitionModelCNN:

    """The HumanActivityRecognitionModelCNN represents the classifier model
    which consist of the combination of a multiple Convolutional layers.
    """
    ...
    def __init__(
        ...
        """Initializes the HumanActivityRecognitionModelCNN class.
        ...
        # self.__train_set_features_reshaped = tf.reshape(self.__train_set_features, [-1, Config.IMAGE_HEIGHT, Config.IMAGE_WIDTH, 3])
    ...
    def __build_model(self) -> Model:
        """Builds Human Activity Recognition Model - CNN variant.

        Returns:
            Model: Built model.
        """
        self.__run_logger.info(
            'Building Human Activity Recognition Model - CNN variant.'
        )
        ...
        model.add(Conv3D(32, (3, 3, Config.SEQUENCE_LENGTH), activation='relu'))
        model.add(
            MaxPooling3D(
                pool_size=(1, 2, 2),
                padding='same',
        ...
        self.__run_logger.info(
            'Finished building Human Activity Recognition Model - CNN '
            'variant.'
        )
