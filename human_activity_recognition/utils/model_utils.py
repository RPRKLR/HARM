...
from human_activity_recognition.data_processing.data_processor import (
    DataProcessor,
)
...
def run_pipeline(
    run_progress_file_path: str,
    run_progress_message: str,
) -> None:
    ...
    Args:
        ...
        run_progress_message (str): Message saved to output file.
    """
    pipeline = Pipeline()
    pipeline.run()
...
def run_prediction(
    ...
    data_processor = DataProcessor(logger=None, data_classes=None)
